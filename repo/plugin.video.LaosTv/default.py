...
ADDON = __settings__ = xbmcaddon.Addon(id='plugin.video.LaosTv')
home = __settings__.getAddonInfo('path')
filename = xbmc.translatePath(os.path.join(home, 'resources', 'LaosTv.xml'))

if ADDON.getSetting('ga_visitor')=='':
    from random import randint
    ADDON.setSetting('ga_visitor',str(randint(0, 0x7fffffff)))
    
PATH = "LaosTv"  #<---- PLUGIN NAME MINUS THE "plugin.video"          
